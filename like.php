...
<br />
<br />
 <div style="position: absolute; width: 239px; height: 231px; z-index: 1; left: 3px; top: 3px" id="layer4">
	
&nbsp;<div style="position: absolute; width: 223px; height: 72px; z-index: 1; left: 7px; top: 135px" id="layer6" class="style5">
	&nbsp;<strong>welcome:<?php echo "$uid"; ?> </strong></div>
&nbsp;<img src="<?php echo $uimg; ?>" height="123" width="170" /><br />
<br />
</div>
</div>
<div style="position: absolute; width: 241px; height: 201px; z-index: 2; left: 172px; top: 641px" id="layer3" class="style1">
...
$laid=$_GET["id"];
$aid=$_GET["aid"];
$qry=" select ifnull(max(likeid),0) from tblike ";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
$row=mysqli_fetch_row($result);
$n=$row[0];
$n++;
$qry="insert into tblike values($n,'$uid',$laid)";
mysqli_query($con,$qry) or die(mysqli_error($con));
header("location:album.php?aid=$aid");
