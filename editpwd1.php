...
<form method="post" action="editpwd2.php">
	<table style="width: 100%">
		<tr>
			<td style="width: 172px">enter new password</td>
			<td style="width: 218px"><input name="Password1" type="password" />&nbsp;</td>
			<td>&nbsp;<span id="s1"></span></td>
		</tr>
		<tr>
			<td style="width: 172px">confirm password</td>
			<td style="width: 218px"><input name="Password2" type="password" />&nbsp;</td>
			<td>&nbsp;<span id="s1"></span></td>
		</tr>
		<tr>
