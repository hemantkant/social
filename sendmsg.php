...
echo "sending message to $id";
?>
<form method="post" action="sendmsg2.php">
&nbsp;<input name="Text1" type="text" style="height: 37px; width: 256px" placeholder="type message" /><br />
	<br />
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="Submit1" type="submit" value="send" style="width: 83px" /><br />
	<br />
	<br />
	<br />
	<br />
