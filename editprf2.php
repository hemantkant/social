...
$udob=$_POST["Text6"]; 
include("db.php");
$qry="update tbuser set username='$unm', useradd='$uadd', usermob='$umob', userqualification='$uqf', userinterest='$uint', userdob='$udob' where userid='$uid' ";
mysqli_query($con,$qry) or die(mysqli_error($con));
?>
<br />
<strong><span class="style3">update profile successfully!!
</span></strong>
