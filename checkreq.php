...
if($n>0){
$qry=" select a.userid,b.userimg from tbfriend a,tbuser b where a.fid='$uid' and a.status=0 and a.userid=b.userid";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
echo "<table>";
while($row=mysqli_fetch_row($result)){
echo "<tr>";
echo "<td>";
echo "<img src=$row[1] height=60 width=60>";
echo "</td>";
echo "<td><a href=viewprf2.php?id=$row[0]>$row[0]</a> </td>"; 
echo "</tr>";
...
echo "<font size=5 color=red>you have no incoming request</font>";
}
?>
