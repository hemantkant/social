...
<div style="position: absolute; width: 912px; height: 687px; z-index: 3; left: 442px; top: 425px" id="layer5" class="style1">
<?php
include("db.php");
...
$qry=" select ifnull(max(commentid),0) from tbcomment ";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
$row=mysqli_fetch_row($result);
$n=$row[0];
$n++;
...
$tid=$_GET["tid"];
$qry=" insert into tbcomment values($n,'$desc','$date','$time','$uid',$tid) ";
mysqli_query($con,$qry) or die(mysqli_error($con));
header("location:readblog.php?tid=$tid");
}
else{
