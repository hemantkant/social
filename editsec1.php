...
<form method="post" action="editsec2.php">
	<table style="width: 100%">
		<tr>
			<td style="width: 221px" class="style7"><strong>choose new security question</strong></td>
		...
		<tr>
			<td style="width: 221px" class="style7"><strong>enter your security answer</strong></td>
