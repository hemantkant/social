...
<br />
friends:</div>
<div style="position: absolute; width: 581px; height: 144px; z-index: 5; left: 584px; top: 688px; overflow:scroll" id="layer8" class="style7">
<?php
include("db.php");
$qry=" select a.fid,b.userimg from tbfriend a,tbuser b where a.userid='$uid' and a.status=1 and a.fid=b.userid";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
echo "<table cellapacing=5>";
echo "<tr>";
while($row=mysqli_fetch_row($result)){

echo "<td align=center>";
echo "<img src=$row[1] height=100 width=100>";
echo "<br><a href=sendmsg.php?id=$row[0]>$row[0]</a> ";
echo "</td>";
}
echo "</tr>";
echo "</table>";
...
<div style="position: absolute; width: 581px; height: 150px; 
 z-index: 4; left: 586px; top: 439px; overflow:scroll " id="layer7" >
<?php
...
<a href=groupdesc.php?gid=$row[0]><img src=$row[2] height=100 width=100></a><br><br>
</td>";
