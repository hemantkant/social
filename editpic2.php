...
<div style="position: absolute; width: 912px; height: 687px; z-index: 3; left: 448px; top: 423px" id="layer5">
<?php 
include("db.php");
$old=$_FILES["File1"]["tmp_name"];
$new="images/".$uid."_".$_FILES["File1"]["name"];
move_uploaded_file($old,$new);
$qry=" update tbuser set userimg='$new' where userid='$uid' ";
