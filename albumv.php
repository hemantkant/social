...
<?php
include("db.php");
$qry=" select ifnull(max(albumvcid),0) from tbalbumvcontent ";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
$row=mysqli_fetch_row($result);
$n=$row[0];
$n++;
$old=$_FILES["File2"]["tmp_name"];
$new="video/".$n."_".$_FILES["File2"]["name"];
move_uploaded_file($old,$new);
$qry=" insert into tbalbumvcontent values($n,'$uid','$new',$aid) ";
