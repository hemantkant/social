...
<a href="search.php"><img src="images/usearch.jpg" height="150" width="200"/></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div style="position: absolute; width: 38px; height: 29px; z-index: 1; left: 477px; top: 120px" id="layer6">
<?php
include("db.php");
$qry="select * from tbfriend where fid='$uid' and status=0";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
$n=mysqli_num_rows($result);
echo "<font size=5 color=red>$n</font>";
?>
</div>
&nbsp;<a href="checkreq.php"><img src="images/request.jpg" height="150" width="200"/></a><br />
