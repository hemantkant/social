...
<?php
include("db.php");
$qry="select * from tbmsg where msgtouserid='$uid' ";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
$n=mysqli_num_rows($result);
if($n>0){
$qry=" select b.userimg,a.msgid,a.msgfromuserid,a.msgdesc,a.msgdate,a.msgtime from tbmsg a, tbuser b  where a.msgfromuserid=b.userid and a.msgtouserid='$uid' ";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
echo "<table>";
while($row=mysqli_fetch_row($result)){
echo "<tr>";
echo "<td>
<img src=$row[0] height=60 width=60><br><br>
     </td>";
echo "<td valign=top>
<font size=3 color=red>$row[3]</font>
<br>
<font size=2>posted by: $row[2]</font><br>
<font size=1>$row[4]&nbsp;&nbsp;&nbsp;$row[5]</font>
</td>";  
echo "<td><br>
<a href=sendmsg.php?id=$row[2]><font size=2>reply</font></a>
</td>";
echo "<td><br>
<a href=delmsg.php?msgid=$row[1]><font size=2>delete</font></a>
</td>";   
...
echo "<font size=5 color=maroon>you have no message in your inbox!!</font>";
}
?>
