...
<div style="position: absolute; width: 912px; height: 687px; z-index: 3; left: 523px; top: 386px" id="layer5" class="style6">
<?php
      include("db.php");
      $id=$_GET["id"];
      if($id!=$uid){
...
<form method="post" action="">
	...
	<table style="width: 100%" border="0">
		...
		<tr>
	        <td align="center"><a href="galleryprf.php?id=<?php echo $id ?>">gallery</a></td>
	        <td>&nbsp;
	        <?php
	        $qry=" select * from tbfriend where userid='$uid' and fid='$id'";
	        $result=mysqli_query($con,$qry) or die(mysqli_error($con));
	        $n=mysqli_num_rows($result);
            if($n>0){
            $row=mysqli_fetch_row($result);
            ...
            echo "<a href=sendreq.php?id=$id> send friend request </a>";
            } 
	        ?>
	        </td>  	
		</tr>
...
header("location:sameuser.php?id=$id");
}
?>
